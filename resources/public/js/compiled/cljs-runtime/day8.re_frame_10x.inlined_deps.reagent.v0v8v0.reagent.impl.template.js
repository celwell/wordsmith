...
var G__46157 = o;
(G__46157[day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.template.cached_custom_prop_name(k)] = day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.template.convert_prop_value(v));
...
var G__46168 = props;
var G__46168__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__46168,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__46168);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__46168__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.template.stringify_class = (function day8$re_frame_10x$inlined_deps$reagent$v0v8v0$reagent$impl$template$stringify_class(p__46170){
...
var props = map__46171__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46171__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.template.input_node_set_value = (function day8$re_frame_10x$inlined_deps$reagent$v0v8v0$reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__46176){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46177__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.batching.do_after_render(((function (node_value,map__46177,map__46177__$1,on_write){
return (function (){
...
});})(node_value,map__46177,map__46177__$1,on_write))
);
} else {
...
var G__46190 = jsprops;
(G__46190["defaultValue"] = value);

(G__46190["onChange"] = ((function (G__46190,v,value,on_change){
return (function (p1__46185_SHARP_){
return day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.template.input_handle_change(this$,on_change,p1__46185_SHARP_);
});})(G__46190,v,value,on_change))
);
...
var vec__46196 = cljs.core.next(cljs.core.re_matches(day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46196,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46196,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46196,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___46286 = day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___46286 == null)){
} else {
var key_46287 = temp__5739__auto___46286;
(jsprops["key"] = key_46287);
}
...
var temp__5739__auto___46292 = day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___46292 == null)){
} else {
var key_46293 = temp__5739__auto___46292;
day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.template.oset(jsprops,"key",key_46293);
}
...
var G__46201 = day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.template.__GT_NativeWrapper();
(G__46201["name"] = c);
...
var G__46205 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__46205) : day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.template.as_element.call(null,G__46205));
} else {
...
/** @this {Function} */
day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq46211){
var G__46212 = cljs.core.first(seq46211);
var seq46211__$1 = cljs.core.next(seq46211);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46212,seq46211__$1);
});
...
break;
default:
var G__46321 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__46321;
continue;
...
var n__4607__auto___46323 = a.length;
var i_46324 = (0);
while(true){
if((i_46324 < n__4607__auto___46323)){
(a[i_46324] = day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.template.as_element((a[i_46324])));

var G__46325 = (i_46324 + (1));
i_46324 = G__46325;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___46326 = a.length;
var i_46327 = (0);
while(true){
if((i_46327 < n__4607__auto___46326)){
var val_46328 = (a[i_46327]);
if(((cljs.core.vector_QMARK_(val_46328)) && ((day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.template.key_from_vec(val_46328) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_46327] = day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.template.as_element(val_46328));

var G__46329 = (i_46327 + (1));
i_46327 = G__46329;
continue;
} else {
}
...
var ctx = ({});
var vec__46223 = day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.ratom.check_derefs(((function (ctx){
return (function (){
return day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46223,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46223,(1),null);
...
var G__46226 = (cljs.core.count(argv) - first_child);
switch (G__46226) {
case (0):
...
case (1):
var G__46227 = comp;
var G__46228 = jsprops;
var G__46229 = day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__46227,G__46228,G__46229);

break;
default:
return module$node_modules$react$index.createElement.apply(null,cljs.core.reduce_kv(((function (G__46226){
