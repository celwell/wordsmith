...
if((typeof devtools !== 'undefined') && (typeof devtools.toolbox !== 'undefined') && (typeof devtools.toolbox.t_devtools$toolbox42600 !== 'undefined')){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox42600 = (function (obj,header,style,tag,meta42601){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
devtools.toolbox.t_devtools$toolbox42600.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_42602,meta42601__$1){
var self__ = this;
var _42602__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox42600(self__.obj,self__.header,self__.style,self__.tag,meta42601__$1));
});

devtools.toolbox.t_devtools$toolbox42600.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_42602){
var self__ = this;
var _42602__$1 = this;
return self__.meta42601;
});

devtools.toolbox.t_devtools$toolbox42600.prototype.devtools$protocols$IFormat$ = cljs.core.PROTOCOL_SENTINEL;

devtools.toolbox.t_devtools$toolbox42600.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox42600.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});

devtools.toolbox.t_devtools$toolbox42600.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox42600.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta42601","meta42601",-721460758,null)], null);
});

devtools.toolbox.t_devtools$toolbox42600.cljs$lang$type = true;

devtools.toolbox.t_devtools$toolbox42600.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox42600";

devtools.toolbox.t_devtools$toolbox42600.cljs$lang$ctorPrWriter = (function (this__4374__auto__,writer__4375__auto__,opt__4376__auto__){
return cljs.core._write(writer__4375__auto__,"devtools.toolbox/t_devtools$toolbox42600");
});

/**
 * Positional factory function for devtools.toolbox/t_devtools$toolbox42600.
 */
devtools.toolbox.__GT_t_devtools$toolbox42600 = (function devtools$toolbox$__GT_t_devtools$toolbox42600(obj__$1,header__$1,style__$1,tag__$1,meta42601){
return (new devtools.toolbox.t_devtools$toolbox42600(obj__$1,header__$1,style__$1,tag__$1,meta42601));
});

}

return (new devtools.toolbox.t_devtools$toolbox42600(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
});
