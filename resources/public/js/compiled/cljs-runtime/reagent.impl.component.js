...
if((i < len)){
var k = (ks[i]);
var G__50720 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__50721 = (i + (1));
m = G__50720;
i = G__50721;
continue;
...
var temp__5737__auto__ = (p["argv"]);
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__50504 = (p["children"]);
return module$node_modules$react$index.Children.toArray(G__50504);
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__50506 = c;
var G__50506__$1 = (((G__50506 == null))?null:G__50506.prototype);
if((G__50506__$1 == null)){
return null;
} else {
return (G__50506__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__50511 = c;
var G__50511__$1 = (((G__50511 == null))?null:G__50511.prototype);
if((G__50511__$1 == null)){
return null;
} else {
return (G__50511__$1["render"]);
}
})() == null)))));
});
...
return (function() { 
var G__50740__delegate = function (args){
var G__50525 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__50525) : reagent.impl.component.as_element.call(null,G__50525));
};
var G__50740 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__50744__i = 0, G__50744__a = new Array(arguments.length -  0);
while (G__50744__i < G__50744__a.length) {G__50744__a[G__50744__i] = arguments[G__50744__i + 0]; ++G__50744__i;}
  args = new cljs.core.IndexedSeq(G__50744__a,0,null);
} 
return G__50740__delegate.call(this,args);};
G__50740.cljs$lang$maxFixedArity = 0;
G__50740.cljs$lang$applyTo = (function (arglist__50745){
var args = cljs.core.seq(arglist__50745);
return G__50740__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__50530 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__50531 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__50531;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__50530;
}});
...
return ((function (G__50544,G__50544__$1){
...
var c = this;
var G__50571_50751 = (c["cljsRatom"]);
if((G__50571_50751 == null)){
} else {
reagent.ratom.dispose_BANG_(G__50571_50751);
}
...
var render_fun_50758 = cljs.core.first(cljs.core.vals(renders_50757));
if((cljs.core.count(renders_50757) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_50757))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_50758)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_50758], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__50623 = name;
switch (G__50623) {
case "":
...
var G__50630 = reagent.impl.component.cljsify(body);
return module$node_modules$create_react_class$index(G__50630);
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__50637 = fiber;
var G__50637__$1 = (((G__50637 == null))?null:(G__50637["type"]));
if((G__50637__$1 == null)){
return null;
} else {
return (G__50637__$1["displayName"]);
}
})();
var parent = (function (){var G__50646 = fiber;
if((G__50646 == null)){
return null;
} else {
return (G__50646["return"]);
}
})();
var path = (function (){var G__50649 = parent;
var G__50649__$1 = (((G__50649 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__50649) : reagent.impl.component.fiber_component_path.call(null,G__50649)));
if((G__50649__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50649__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4131__auto__ = (function (){var G__50666 = c;
if((G__50666 == null)){
return null;
} else {
return (G__50666["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__50667._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__50672 = c;
if((G__50672 == null)){
return null;
} else {
return (G__50672["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = (function (){var G__50679 = c;
if((G__50679 == null)){
return null;
} else {
return G__50679._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4131__auto__ = (function (){var G__50681 = instance;
if((G__50681 == null)){
return null;
} else {
return (G__50681["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__50682 = instance;
if((G__50682 == null)){
return null;
} else {
return G__50682._currentElement;
}
}
})();
var name = (function (){var G__50683 = elem;
var G__50683__$1 = (((G__50683 == null))?null:(G__50683["type"]));
if((G__50683__$1 == null)){
return null;
} else {
return (G__50683__$1["displayName"]);
}
})();
var owner = (function (){var or__4131__auto__ = (function (){var G__50685 = elem;
if((G__50685 == null)){
return null;
} else {
return (G__50685["_owner"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__50686._owner;
}
}
})();
var path = (function (){var G__50687 = owner;
var G__50687__$1 = (((G__50687 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__50687) : reagent.impl.component.component_path.call(null,G__50687)));
if((G__50687__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50687__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__50701 = c;
var G__50701__$1 = (((G__50701 == null))?null:G__50701.constructor);
if((G__50701__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__50701__$1);
}
}
})();
