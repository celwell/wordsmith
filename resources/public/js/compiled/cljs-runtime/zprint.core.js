...
var vec__51307 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__51312 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51312,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51312,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51307,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51307,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__51323){
var vec__51325 = p__51323;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51325,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51325,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51329,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51329,(1),null);
...
var vec__51353 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51353,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51353,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51353,(2),null);
var vec__51356 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51356,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51356,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51356,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__51373){
var vec__51374 = p__51373;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51374,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51374,(1),null);
...
var len__4730__auto___51537 = arguments.length;
var i__4731__auto___51538 = (0);
while(true){
if((i__4731__auto___51538 < len__4730__auto___51537)){
args__4736__auto__.push((arguments[i__4731__auto___51538]));

var G__51540 = (i__4731__auto___51538 + (1));
i__4731__auto___51538 = G__51540;
continue;
} else {
}
break;
...
var vec__51387 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51387,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51387,(1),null);
...
var G__51391 = zprint.core.parse_string_all_options(rest_options);
var G__51392 = zprint.core.czprint_str_internal;
var G__51393 = ":parse-string-all? call";
var G__51394 = (function (){var G__51397 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__51397) : zprint.zutil.edn_STAR_.call(null,G__51397));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__51391,G__51392,G__51393,G__51394) : zprint.core.process_multiple_forms.call(null,G__51391,G__51392,G__51393,G__51394));
} else {
throw (new Error(":parse-string-all? requires a string!"));
}
} else {
var actual_options = zprint.core.determine_options(rest_options);
var vec__51400 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51400,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51400,(1),null);
...
/** @this {Function} */
zprint.core.czprint_str_internal.cljs$lang$applyTo = (function (seq51381){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51382,G__51383,seq51381__$2);
});
...
var G__51574 = (i__4731__auto___51573 + (1));
i__4731__auto___51573 = G__51574;
continue;
} else {
}
break;
...
/** @this {Function} */
zprint.core.zprint_str.cljs$lang$applyTo = (function (seq51418){
var G__51419 = cljs.core.first(seq51418);
var seq51418__$1 = cljs.core.next(seq51418);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51419,seq51418__$1);
});
...
var G__51582 = (i__4731__auto___51581 + (1));
i__4731__auto___51581 = G__51582;
continue;
} else {
}
break;
...
/** @this {Function} */
zprint.core.czprint_str.cljs$lang$applyTo = (function (seq51423){
var G__51424 = cljs.core.first(seq51423);
var seq51423__$1 = cljs.core.next(seq51423);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51424,seq51423__$1);
});
...
var args__4736__auto__ = [];
var len__4730__auto___51593 = arguments.length;
var i__4731__auto___51594 = (0);
while(true){
if((i__4731__auto___51594 < len__4730__auto___51593)){
args__4736__auto__.push((arguments[i__4731__auto___51594]));

var G__51595 = (i__4731__auto___51594 + (1));
i__4731__auto___51594 = G__51595;
continue;
} else {
}
break;
...
/** @this {Function} */
zprint.core.zprint.cljs$lang$applyTo = (function (seq51431){
var G__51432 = cljs.core.first(seq51431);
var seq51431__$1 = cljs.core.next(seq51431);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51432,seq51431__$1);
});
...
var args__4736__auto__ = [];
var len__4730__auto___51597 = arguments.length;
var i__4731__auto___51598 = (0);
while(true){
if((i__4731__auto___51598 < len__4730__auto___51597)){
args__4736__auto__.push((arguments[i__4731__auto___51598]));

var G__51599 = (i__4731__auto___51598 + (1));
i__4731__auto___51598 = G__51599;
continue;
} else {
}
break;
...
/** @this {Function} */
zprint.core.czprint.cljs$lang$applyTo = (function (seq51441){
var G__51442 = cljs.core.first(seq51441);
var seq51441__$1 = cljs.core.next(seq51441);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51442,seq51441__$1);
});
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__51470,form){
var vec__51474 = p__51470;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51474,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51474,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51474,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51474,(3),null);
...
var vec__51477 = (cljs.core.truth_((function (){var and__4120__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4120__auto__)){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51477,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51477,(1),null);
...
var forms = (function (){var G__51499 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__51499) : zprint.zutil.edn_STAR_.call(null,G__51499));
})();
