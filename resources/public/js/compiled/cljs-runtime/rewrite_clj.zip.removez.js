...
var _PERCENT_ = rewrite_clj.zip.whitespace.skip_whitespace.cljs$core$IFn$_invoke$arity$2(clojure.zip.prev,clojure.zip.remove(rewrite_clj.zip.removez.remove_trailing_space(((((rewrite_clj.zip.move.rightmost_QMARK_(zloc)) || (rewrite_clj.zip.move.leftmost_QMARK_(zloc))))?rewrite_clj.zip.removez.remove_preceding_space(zloc,(function (p1__48931_SHARP_){
var and__4120__auto__ = rewrite_clj.zip.whitespace.whitespace_QMARK_(p1__48931_SHARP_);
if(cljs.core.truth_(and__4120__auto__)){
return cljs.core.not(rewrite_clj.zip.whitespace.linebreak_QMARK_(p1__48931_SHARP_));
} else {
return and__4120__auto__;
}
})):zloc),(function (p1__48932_SHARP_){
var and__4120__auto__ = rewrite_clj.zip.whitespace.whitespace_QMARK_(p1__48932_SHARP_);
if(cljs.core.truth_(and__4120__auto__)){
return cljs.core.not(rewrite_clj.zip.whitespace.linebreak_QMARK_(p1__48932_SHARP_));
} else {
return and__4120__auto__;
}
}))));
