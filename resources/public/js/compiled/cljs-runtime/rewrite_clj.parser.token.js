...
return rewrite_clj.reader.read_until(reader,(function (p1__48541_SHARP_){
return ((cljs.core.not((allowed_QMARK_.cljs$core$IFn$_invoke$arity$1 ? allowed_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__48541_SHARP_) : allowed_QMARK_.call(null,p1__48541_SHARP_)))) && (rewrite_clj.reader.whitespace_or_boundary_QMARK_(p1__48541_SHARP_)));
}));
});
...
var G__48542 = (rewrite_clj.reader.read_string.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.reader.read_string.cljs$core$IFn$_invoke$arity$1(s) : rewrite_clj.reader.read_string.call(null,s));
var G__48543 = s;
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__48542,G__48543) : rewrite_clj.node.token_node.call(null,G__48542,G__48543));
}
});
/**
