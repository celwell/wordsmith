...
var o40144 = temp__5733__auto__;
var temp__5733__auto____$1 = (o40144["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o40145 = temp__5733__auto____$1;
return (o40145["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__39895__auto__ = f;
return (o__39895__auto__["toString"]).call(o__39895__auto__);
} else {
return "";
}
...
try{var o__39895__auto___40449 = t;
(o__39895__auto___40449["cljs$lang$ctorPrWriter"]).call(o__39895__auto___40449,t,writer);
}catch (e40154){var __40453 = e40154;
}
...
var char_code = (function (){var o__39895__auto__ = (new String(char$));
return (o__39895__auto__["charCodeAt"]).call(o__39895__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__39895__auto__ = String;
return (o__39895__auto__["fromCharCode"]).call(o__39895__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__40180 = num_code;
switch (G__40180) {
case (1):
return (185);
...
var o__39895__auto__ = String;
return (o__39895__auto__["fromCharCode"]).call(o__39895__auto__,superscript_code);
});
/**
...
}catch (e40207){var _e__39905__auto__ = e40207;
return false;
}})())){
...
var vec__40208 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40208,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o40251 = temp__5733__auto__;
var temp__5733__auto____$1 = (o40251["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o40252 = temp__5733__auto____$1;
return (o40252["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__40272){
var vec__40273 = p__40272;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40273,(0),null);
...
var G__40495 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__40496 = cljs.core.butlast(remaining_tokens);
name_tokens = G__40495;
remaining_tokens = G__40496;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq40267){
var G__40268 = cljs.core.first(seq40267);
var seq40267__$1 = cljs.core.next(seq40267);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40268,seq40267__$1);
});
...
var vec__40284 = cljs.core.split_with((function (p1__40281_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__40281_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40284,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40284,(1),null);
...
var vec__40295 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40295,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40295,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__40518 = cljs.core.rest(remaining_tokens);
var G__40519 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__40518;
name_tokens = G__40519;
continue;
} else {
...
var vec__40304 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40304,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40304,(1),null);
var vec__40307 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40307,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40307,(1),null);
var vec__40310 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40310,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40310,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40310,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40310,(3),null);
...
var vec__40321 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40321,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40321,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40321,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40321,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40321,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40321,(5),null);
...
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40324,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40324,(1),null);
var vec__40327 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40327,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40327,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__40336 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__40336) : devtools.munging.parse_fn_info_deep.call(null,G__40336));
})()));
}
} else {
return fn_info;
...
var G__40553 = (arity + (1));
var G__40554 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__40344){
var vec__40345 = p__40344;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40345,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40345,(1),null);
...
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__40353_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__40354_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__40362){
var vec__40363 = p__40362;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40363,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq40356){
var G__40357 = cljs.core.first(seq40356);
var seq40356__$1 = cljs.core.next(seq40356);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40357,seq40356__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40381__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40381__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40381__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40381__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__40382 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40382,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40382,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40382,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40382,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40382,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40382,(5),null);
...
var o__39895__auto__ = f;
return (o__39895__auto__["getBasis"]).call(o__39895__auto__);
});
/**
...
}catch (e40398){var _e__39905__auto__ = e40398;
...
var G__40611 = (obj[cljs.core.first(path)]);
var G__40612 = cljs.core.rest(path);
obj = G__40611;
path = G__40612;
continue;
} else {
...
return (function (accum,p__40414){
var vec__40415 = p__40414;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40415,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40415,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__40420){
var vec__40421 = p__40420;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40421,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40421,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40421,(2),null);
...
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40445,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40445,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (name,sorted_matches,vec__40445,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__40430_SHARP_){
return (obj[cljs.core.first(p1__40430_SHARP_)]);
});})(name,sorted_matches,vec__40445,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
