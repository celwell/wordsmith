...
day8.re_frame_10x.view.components.search_input = (function day8$re_frame_10x$view$components$search_input(p__47475){
...
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47476__$1,new cljs.core.Keyword(null,"title","title",636505583));
var placeholder = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47476__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
var on_save = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47476__$1,new cljs.core.Keyword(null,"on-save","on-save",1618176266));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47476__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var on_stop = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47476__$1,new cljs.core.Keyword(null,"on-stop","on-stop",1520114515));
var val = day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.core.atom.cljs$core$IFn$_invoke$arity$1(title);
var save = ((function (val,map__47476,map__47476__$1,title,placeholder,on_save,on_change,on_stop){
return (function (){
...
});})(val,map__47476,map__47476__$1,title,placeholder,on_save,on_change,on_stop))
;
return ((function (val,save,map__47476,map__47476__$1,title,placeholder,on_save,on_change,on_stop){
return (function (){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(val),new cljs.core.Keyword(null,"auto-focus","auto-focus",1250006231),true,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),placeholder,new cljs.core.Keyword(null,"size","size",1098693007),((((20) > cljs.core.count(cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(val)))))?(25):cljs.core.count(cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(val)))),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (val,save,map__47476,map__47476__$1,title,placeholder,on_save,on_change,on_stop){
return (function (p1__47473_SHARP_){
cljs.core.reset_BANG_(val,p1__47473_SHARP_.target.value);

return (on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(p1__47473_SHARP_) : on_change.call(null,p1__47473_SHARP_));
});})(val,save,map__47476,map__47476__$1,title,placeholder,on_save,on_change,on_stop))
,new cljs.core.Keyword(null,"on-key-down","on-key-down",-1374733765),((function (val,save,map__47476,map__47476__$1,title,placeholder,on_save,on_change,on_stop){
return (function (p1__47474_SHARP_){
var G__47480 = p1__47474_SHARP_.which;
switch (G__47480) {
case (13):
save();
...
day8.re_frame_10x.view.components.autoscroll_list = (function day8$re_frame_10x$view$components$autoscroll_list(p__47488,child){
...
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47489__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var scroll_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47489__$1,new cljs.core.Keyword(null,"scroll?","scroll?",-1393045951));
...
return day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.core.create_class(new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"display-name","display-name",694513143),"autoscroll-list",new cljs.core.Keyword(null,"component-did-mount","component-did-mount",-1126910518),((function (node,should_scroll,map__47489,map__47489__$1,class$,scroll_QMARK_){
return (function (_){
...
});})(node,should_scroll,map__47489,map__47489__$1,class$,scroll_QMARK_))
,new cljs.core.Keyword(null,"component-will-update","component-will-update",335247566),((function (node,should_scroll,map__47489,map__47489__$1,class$,scroll_QMARK_){
return (function (_){
...
,new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),((function (node,should_scroll,map__47489,map__47489__$1,class$,scroll_QMARK_){
return (function (_){
...
,new cljs.core.Keyword(null,"reagent-render","reagent-render",-985383853),((function (node,should_scroll,map__47489,map__47489__$1,class$,scroll_QMARK_){
return (function (p__47494,child__$1){
...
var class$__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47495__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),class$__$1,new cljs.core.Keyword(null,"ref","ref",1289896967),((function (map__47495,map__47495__$1,class$__$1,node,should_scroll,map__47489,map__47489__$1,class$,scroll_QMARK_){
return (function (dom_node){
return cljs.core.reset_BANG_(node,dom_node);
});})(map__47495,map__47495__$1,class$__$1,node,should_scroll,map__47489,map__47489__$1,class$,scroll_QMARK_))
], null),child__$1], null);
});})(node,should_scroll,map__47489,map__47489__$1,class$,scroll_QMARK_))
], null));
});
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__47498){
var vec__47499 = p__47498;
var property = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47499,(0),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47499,(1),null);
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(property),value);
}),cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__47497_SHARP_){
return clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__47497_SHARP_,/:/);
...
var len__4730__auto___47546 = arguments.length;
var i__4731__auto___47547 = (0);
while(true){
if((i__4731__auto___47547 < len__4730__auto___47546)){
args__4736__auto__.push((arguments[i__4731__auto___47547]));

var G__47548 = (i__4731__auto___47547 + (1));
i__4731__auto___47547 = G__47548;
continue;
} else {
}
break;
...
var previous_config__47458__auto__ = devtools.prefs.get_prefs();
var prefs__47459__auto__ = day8.re_frame_10x.view.components.effective_cljs_devtools_prefs;
try{devtools.prefs.set_prefs_BANG_(prefs__47459__auto__);

return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(api_fn,args);
}finally {if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.prefs.get_prefs(),prefs__47459__auto__)){
} else {
throw (new Error(["Assert failed: ","someone modified devtools.prefs behind our back!","\n","(clojure.core/= (devtools.prefs/get-prefs) prefs__47459__auto__)"].join('')));
}

devtools.prefs.set_prefs_BANG_(previous_config__47458__auto__);
}});

day8.re_frame_10x.view.components.make_devtools_api_call.cljs$lang$maxFixedArity = (1);

/** @this {Function} */
day8.re_frame_10x.view.components.make_devtools_api_call.cljs$lang$applyTo = (function (seq47503){
var G__47504 = cljs.core.first(seq47503);
var seq47503__$1 = cljs.core.next(seq47503);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47504,seq47503__$1);
});
...
var args__4736__auto__ = [];
var len__4730__auto___47549 = arguments.length;
var i__4731__auto___47550 = (0);
while(true){
if((i__4731__auto___47550 < len__4730__auto___47549)){
args__4736__auto__.push((arguments[i__4731__auto___47550]));

var G__47551 = (i__4731__auto___47550 + (1));
i__4731__auto___47550 = G__47551;
continue;
} else {
}
break;
...
/** @this {Function} */
day8.re_frame_10x.view.components.cljs_devtools_header.cljs$lang$applyTo = (function (seq47506){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq47506));
});
...
var args__4736__auto__ = [];
var len__4730__auto___47553 = arguments.length;
var i__4731__auto___47554 = (0);
while(true){
if((i__4731__auto___47554 < len__4730__auto___47553)){
args__4736__auto__.push((arguments[i__4731__auto___47554]));

var G__47555 = (i__4731__auto___47554 + (1));
i__4731__auto___47554 = G__47555;
continue;
} else {
}
break;
...
/** @this {Function} */
day8.re_frame_10x.view.components.cljs_devtools_body.cljs$lang$applyTo = (function (seq47507){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq47507));
});
...
var args__4736__auto__ = [];
var len__4730__auto___47556 = arguments.length;
var i__4731__auto___47557 = (0);
while(true){
if((i__4731__auto___47557 < len__4730__auto___47556)){
args__4736__auto__.push((arguments[i__4731__auto___47557]));

var G__47558 = (i__4731__auto___47557 + (1));
i__4731__auto___47557 = G__47558;
continue;
} else {
}
break;
...
/** @this {Function} */
day8.re_frame_10x.view.components.cljs_devtools_has_body.cljs$lang$applyTo = (function (seq47511){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq47511));
});
...
var expanded_QMARK_ = (function (){var G__47516 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("app-db","node-expanded?","app-db/node-expanded?",-1032853540),path], null);
return (day8.re_frame_10x.inlined_deps.re_frame.v0v10v6.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.re_frame.v0v10v6.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__47516) : day8.re_frame_10x.inlined_deps.re_frame.v0v10v6.re_frame.core.subscribe.call(null,G__47516));
})();
...
return (function (){
var G__47517 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("app-db","toggle-expansion","app-db/toggle-expansion",-1617765538),path__$1], null);
return (day8.re_frame_10x.inlined_deps.re_frame.v0v10v6.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.re_frame.v0v10v6.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__47517) : day8.re_frame_10x.inlined_deps.re_frame.v0v10v6.re_frame.core.dispatch.call(null,G__47517));
});})(expanded_QMARK_))
...
})())?(function (){var G__47518 = day8.re_frame_10x.view.components.cljs_devtools_body.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([day8.re_frame_10x.view.components.get_object(jsonml__$1),day8.re_frame_10x.view.components.get_config(jsonml__$1)], 0));
var G__47519 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(path__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
return (day8.re_frame_10x.view.components.jsonml__GT_hiccup.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame_10x.view.components.jsonml__GT_hiccup.cljs$core$IFn$_invoke$arity$2(G__47518,G__47519) : day8.re_frame_10x.view.components.jsonml__GT_hiccup.call(null,G__47518,G__47519));
})():(function (){var G__47520 = day8.re_frame_10x.view.components.cljs_devtools_header.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([day8.re_frame_10x.view.components.get_object(jsonml__$1),day8.re_frame_10x.view.components.get_config(jsonml__$1)], 0));
var G__47521 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(path__$1,new cljs.core.Keyword(null,"header","header",119441134));
return (day8.re_frame_10x.view.components.jsonml__GT_hiccup.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame_10x.view.components.jsonml__GT_hiccup.cljs$core$IFn$_invoke$arity$2(G__47520,G__47521) : day8.re_frame_10x.view.components.jsonml__GT_hiccup.call(null,G__47520,G__47521));
})())], null);
});
;})(expanded_QMARK_))
});
...
var vec__47523 = jsonml;
var seq__47524 = cljs.core.seq(vec__47523);
var first__47525 = cljs.core.first(seq__47524);
var seq__47524__$1 = cljs.core.next(seq__47524);
var tag_name = first__47525;
var first__47525__$1 = cljs.core.first(seq__47524__$1);
var seq__47524__$2 = cljs.core.next(seq__47524__$1);
var attributes = first__47525__$1;
var children = seq__47524__$2;
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(tag_name),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),day8.re_frame_10x.view.components.string__GT_css(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$1(attributes),"style"))], null)], null),cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$1(((function (vec__47523,seq__47524,first__47525,seq__47524__$1,tag_name,first__47525__$1,seq__47524__$2,attributes,children,tagnames){
return (function (i,child){
var G__47526 = child;
var G__47527 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(path,i);
return (day8.re_frame_10x.view.components.jsonml__GT_hiccup.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame_10x.view.components.jsonml__GT_hiccup.cljs$core$IFn$_invoke$arity$2(G__47526,G__47527) : day8.re_frame_10x.view.components.jsonml__GT_hiccup.call(null,G__47526,G__47527));
});})(vec__47523,seq__47524,first__47525,seq__47524__$1,tag_name,first__47525__$1,seq__47524__$2,attributes,children,tagnames))
),children);
} else {
...
var expanded_QMARK_ = (function (){var G__47529 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("app-db","node-expanded?","app-db/node-expanded?",-1032853540),path], null);
return (day8.re_frame_10x.inlined_deps.re_frame.v0v10v6.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.re_frame.v0v10v6.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__47529) : day8.re_frame_10x.inlined_deps.re_frame.v0v10v6.re_frame.core.subscribe.call(null,G__47529));
})();
return ((function (expanded_QMARK_){
...
return (function (){
var G__47530 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("app-db","toggle-expansion","app-db/toggle-expansion",-1617765538),path], null);
return (day8.re_frame_10x.inlined_deps.re_frame.v0v10v6.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.re_frame.v0v10v6.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__47530) : day8.re_frame_10x.inlined_deps.re_frame.v0v10v6.re_frame.core.dispatch.call(null,G__47530));
});})(expanded_QMARK_))
...
var args__4736__auto__ = [];
var len__4730__auto___47574 = arguments.length;
var i__4731__auto___47576 = (0);
while(true){
if((i__4731__auto___47576 < len__4730__auto___47574)){
...
day8.re_frame_10x.view.components.simple_render.cljs$core$IFn$_invoke$arity$variadic = (function (data,path,p__47536){
var vec__47537 = p__47536;
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47537,(0),null);
var expanded_QMARK_ = day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.core.atom.cljs$core$IFn$_invoke$arity$1(true);
return ((function (expanded_QMARK_,vec__47537,class$){
return (function (data__$1){
...
;})(expanded_QMARK_,vec__47537,class$))
});

day8.re_frame_10x.view.components.simple_render.cljs$lang$maxFixedArity = (2);

/** @this {Function} */
day8.re_frame_10x.view.components.simple_render.cljs$lang$applyTo = (function (seq47532){
...
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47533,G__47534,seq47532__$2);
});
...
day8.re_frame_10x.view.components.highlight = day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.core.adapt_react_class((function (){var or__4131__auto__ = module$node_modules$react_highlight_DOT_js$dist$main.default;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
