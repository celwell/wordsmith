...
args__4736__auto__.push((arguments[i__4731__auto___40641]));

var G__40642 = (i__4731__auto___40641 + (1));
i__4731__auto___40641 = G__40642;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq40549){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40550,G__40551,seq40549__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__40577_SHARP_){
return (!((cljs.core.meta(p1__40577_SHARP_) == null)));
})))){
...
}catch (e40596){var _e__39905__auto__ = e40596;
return false;
}})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
}catch (e40598){var _e__39905__auto__ = e40598;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__40613 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__40614 = devtools.formatters.state.get_current_state();
devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__40614;

try{var map__40618 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40618__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__40613;
}});
...
;
var temp__5733__auto___40677 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___40677)){
var managed_print_level_40678 = temp__5733__auto___40677;
var _STAR_print_level_STAR__orig_val__40625_40679 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__40626_40680 = managed_print_level_40678;
cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__40626_40680;

try{devtools.formatters.state.update_current_state_BANG_(((function (_STAR_print_level_STAR__orig_val__40625_40679,_STAR_print_level_STAR__temp_val__40626_40680,managed_print_level_40678,temp__5733__auto___40677,writer,opts,job_fn){
return (function (p1__40620_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__40620_SHARP_,null);
});})(_STAR_print_level_STAR__orig_val__40625_40679,_STAR_print_level_STAR__temp_val__40626_40680,managed_print_level_40678,temp__5733__auto___40677,writer,opts,job_fn))
);

job_fn();
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__40625_40679;
}} else {
job_fn();
}
