...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__49116_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__49116_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__49116_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__49117){
var vec__49118 = p__49117;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49118,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49118,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__49122,s,color,element,idx){
...
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49123__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49123__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49123__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__49128 = (function (){var or__4131__auto__ = color;
...
var fexpr__49127 = (function (){var G__49130 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__49130) : style_map.call(null,G__49130));
})();
return (fexpr__49127.cljs$core$IFn$_invoke$arity$1 ? fexpr__49127.cljs$core$IFn$_invoke$arity$1(G__49128) : fexpr__49127.call(null,G__49128));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__49136){
var vec__49137 = p__49136;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49137,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49137,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49137,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__49141){
var vec__49142 = p__49141;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49142,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49142,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49142,(2),null);
...
var G__49615 = cljs.core.next(ssv);
var G__49616 = (this_ssv == null);
var G__49617 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__49618 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__49615;
doing_nil_QMARK_ = G__49616;
last_elide = G__49617;
out = G__49618;
continue;
}
...
var vec__49175 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49175,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49175,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49175,(2),null);
...
var G__49627 = cljs.core.next(remaining_cvec);
var G__49628 = new_idx;
var G__49629 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__49627;
idx = G__49628;
out = G__49629;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__49251,cursor_vec){
var vec__49252 = p__49251;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49252,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49252,(1),null);
var focus_vec = vec__49252;
...
var vec__49255 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49255,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49255,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__49268){
var vec__49271 = p__49268;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49271,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49271,(1),null);
if((color == null)){
return s;
} else {
...
zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__49306,existing_count){
var vec__49307 = p__49306;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49307,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49307,(1),null);
...
return cljs.core.filterv(((function (s__$1,len,cursor__$1,vec__49307,s,cursor){
return (function (p1__49291_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__49291_SHARP_))));
});})(s__$1,len,cursor__$1,vec__49307,s,cursor))
...
var vec__49453 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49453,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49453,(1),null);
var cvec_element = vec__49453;
if((cvec_element == null)){
var G__49692 = cljs.core.next(cvec_nl);
var G__49693 = (idx + (1));
var G__49694 = start;
var G__49695 = out;
cvec_nl = G__49692;
...
var G__49696 = cljs.core.next(cvec_nl);
var G__49697 = (idx + (1));
var G__49698 = idx;
var G__49699 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__49696;
idx = G__49697;
start = G__49698;
out = G__49699;
...
var G__49700 = cljs.core.next(cvec_nl);
var G__49701 = (idx + (1));
var G__49702 = (idx + (1));
var G__49703 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__49700;
idx = G__49701;
start = G__49702;
out = G__49703;
...
var G__49704 = cljs.core.next(cvec_nl);
var G__49705 = (idx + (1));
var G__49706 = idx;
var G__49707 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__49704;
idx = G__49705;
start = G__49706;
out = G__49707;
...
var G__49708 = cljs.core.next(cvec_nl);
var G__49709 = (idx + (1));
var G__49710 = start;
var G__49711 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__49708;
idx = G__49709;
start = G__49710;
out = G__49711;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__49463_SHARP_,p2__49462_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__49462_SHARP_)){
return cljs.core.reduced(p1__49463_SHARP_);
} else {
return (p1__49463_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__49468,p__49469){
var vec__49470 = p__49468;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49470,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49470,(1),null);
var vec__49473 = p__49469;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49473,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49473,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__49595,cvec,focus_vec){
...
var options = map__49596__$1;
var map__49597 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49596__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49597__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49597__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49597__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (lines_to_cvec,surround,cvec_ranges,cvec_ranges__$1,path_vecs,map__49596,map__49596__$1,options,map__49597,map__49597__$1,focus,lines,paths){
return (function (p1__49594_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__49594_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
});})(lines_to_cvec,surround,cvec_ranges,cvec_ranges__$1,path_vecs,map__49596,map__49596__$1,options,map__49597,map__49597__$1,focus,lines,paths))
,path_vecs);
