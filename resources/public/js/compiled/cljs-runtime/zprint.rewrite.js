...
var G__49635 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__49635;
continue;
} else {
var G__49637 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__49637;
continue;
}
} else {
var G__49638 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__49638;
continue;
}
}
...
var G__49602 = zloc;
var G__49603 = (function (){var G__49604 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__49605 = zloc;
var G__49605__$1 = (((G__49605 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__49605) : rewrite_clj.zip.node.call(null,G__49605)));
if((G__49605__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__49605__$1) : zprint.zutil.edn_STAR_.call(null,G__49605__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__49604) : rewrite_clj.zip.root.call(null,G__49604));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__49602,G__49603) : rewrite_clj.zip.replace.call(null,G__49602,G__49603));
});
/**
...
var G__49647 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__49647;
continue;
}
break;
...
var G__49652 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__49653 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__49652;
out = G__49653;
continue;
} else {
...
var G__49659 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__49660 = cljs.core.next(new_loc);
var G__49661 = replaced_loc;
nloc = G__49659;
new_loc = G__49660;
last_loc = G__49661;
continue;
...
return zprint.rewrite.sort_val((function (){var G__49614 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__49614) : rewrite_clj.zip.down.call(null,G__49614));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__49619_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__49619_SHARP_) : rewrite_clj.zip.tag.call(null,p1__49619_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__49619_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__49619_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
