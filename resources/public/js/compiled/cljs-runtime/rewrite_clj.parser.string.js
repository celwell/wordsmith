...
if((c === "\n")){
var G__48537 = escape_QMARK_;
var G__48538 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__48537;
lines = G__48538;
continue;
} else {
buf.append(c);

var G__48539 = (((!(escape_QMARK_))) && ((c === "\\")));
var G__48540 = lines;
escape_QMARK_ = G__48539;
lines = G__48540;
continue;
...
var G__48534 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__48534) : rewrite_clj.node.string_node.call(null,G__48534));
});
...
var G__48535 = cljs.core.re_pattern(regex);
var G__48536 = ["#\"",cljs.core.str.cljs$core$IFn$_invoke$arity$1(regex),"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__48535,G__48536) : rewrite_clj.node.token_node.call(null,G__48535,G__48536));
});
