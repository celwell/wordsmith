...
var G__40254 = cljs.core.PersistentArrayMap.EMPTY;
var G__40255 = native_stack_trace;
var G__40256 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__40257 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__40254,G__40255,G__40256,G__40257) : cljs.stacktrace.parse_stacktrace.call(null,G__40254,G__40255,G__40256,G__40257));
});
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40269__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40269__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40269__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e40263){var _e = e40263;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___40330 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___40330)){
var seen_errors_40332 = temp__5733__auto___40330;
if(cljs.core.truth_(seen_errors_40332.has(self))){
} else {
seen_errors_40332.add(self);

var temp__5735__auto___40333 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___40333)){
var sense_40334 = temp__5735__auto___40333;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_40334)].join('');
} else {
}
}
} else {
