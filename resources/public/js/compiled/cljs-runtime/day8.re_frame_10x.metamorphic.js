...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__51748_SHARP_){
return (((beginning <= new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__51748_SHARP_))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__51748_SHARP_) <= ending)));
}));
});
...
var G__51804 = new cljs.core.Keyword(null,"op-type","op-type",-1636141668).cljs$core$IFn$_invoke$arity$1(trace);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("sub","dispose","sub/dispose",365440536),p1__51815_SHARP_);
});})(and__4120__auto__))
...
return cljs.core.assoc_in(state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"operation","operation",-1267664310).cljs$core$IFn$_invoke$arity$1(trace),new cljs.core.Keyword(null,"layer","layer",-1601820589)], null),(cljs.core.truth_(cljs.core.some((function (p1__51856_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(app_db_id,p1__51856_SHARP_);
...
})),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__51864){
var vec__51865 = p__51864;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51865,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51865,(1),null);
...
var new_state = (function (){var G__51873 = new cljs.core.Keyword(null,"op-type","op-type",-1636141668).cljs$core$IFn$_invoke$arity$1(trace);
...
break;
case "sub/run":
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(state,reaction_id,((function (G__51873,G__51873__$1,tags,reaction_id,state){
...
});})(G__51873,G__51873__$1,tags,reaction_id,state))
);
...
return (function (all_state,p__51876){
var vec__51878 = p__51876;
var sub_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51878,(0),null);
var sub_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51878,(1),null);
