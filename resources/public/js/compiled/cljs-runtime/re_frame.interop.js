...
return [(function (){var pred__51116 = cljs.core.instance_QMARK_;
var expr__51117 = reactive_val;
if(cljs.core.truth_((pred__51116.cljs$core$IFn$_invoke$arity$2 ? pred__51116.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__51117) : pred__51116.call(null,reagent.ratom.RAtom,expr__51117)))){
return "ra";
} else {
if(cljs.core.truth_((pred__51116.cljs$core$IFn$_invoke$arity$2 ? pred__51116.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__51117) : pred__51116.call(null,reagent.ratom.RCursor,expr__51117)))){
return "rc";
} else {
if(cljs.core.truth_((pred__51116.cljs$core$IFn$_invoke$arity$2 ? pred__51116.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__51117) : pred__51116.call(null,reagent.ratom.Reaction,expr__51117)))){
return "rx";
} else {
if(cljs.core.truth_((pred__51116.cljs$core$IFn$_invoke$arity$2 ? pred__51116.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__51117) : pred__51116.call(null,reagent.ratom.Track,expr__51117)))){
return "tr";
} else {
return "other";
}
