...
var G__49030 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__49030__$1 = (((G__49030 == null))?null:cljs.core.iterate(((function (G__49030,n0,temp__5733__auto__){
return (function (loc){
...
});})(G__49030,n0,temp__5733__auto__))
,G__49030));
var G__49030__$2 = (((G__49030__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__49030__$1));
var G__49030__$3 = (((G__49030__$2 == null))?null:cljs.core.last(G__49030__$2));
if((G__49030__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__49030__$3);
}
} else {
return zloc;
}
...
var G__49047 = rewrite_clj.zip.move.right(v);
var G__49048 = rewrite_clj.zip.move.up(v);
loc = G__49047;
parent = G__49048;
continue;
} else {
var G__49049 = rewrite_clj.zip.move.right(v0);
var G__49050 = parent;
loc = G__49049;
parent = G__49050;
continue;
...
var G__49051 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__49052 = rewrite_clj.zip.move.up(v);
loc = G__49051;
parent = G__49052;
continue;
} else {
var G__49053 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__49054 = parent;
loc = G__49053;
parent = G__49054;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__49043 = zloc;
var G__49043__$1 = (((G__49043 == null))?null:rewrite_clj.zip.move.down(G__49043));
var G__49043__$2 = (((G__49043__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__49043__$1,k));
if((G__49043__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__49043__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__49044 = rewrite_clj.zip.move.down(zloc);
var G__49044__$1 = (((G__49044 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__49044));
if((G__49044__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__49044__$1);
}
})(),k);
}
});
