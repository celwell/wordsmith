...
var G__40540 = devtools.prefs.pref(v);
v = G__40540;
continue;
} else {
return v;
...
}catch (e40476){var _e__39905__auto__ = e40476;
return false;
}})();
...
}catch (e40486){var _e__39905__auto__ = e40486;
return false;
}})();
...
}catch (e40488){var _e__39905__auto__ = e40488;
return false;
}}
}
});
...
var vec__40515 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40515,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40515,(1),null);
...
return cljs.core.some((function (p1__40524_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__40524_SHARP_);
}),template);
});
