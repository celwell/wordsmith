...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__60230_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__60230_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__60229_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__60229_SHARP_),"#"].join('');
...
return (((p1__60231_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__60231_SHARP_) == null)));
});})(gen_name,name_for))
 ...
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__60237,mapping){
...
var state = map__60238__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60238__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60238__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60238__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (map__60238,map__60238__$1,state,context,refers,aliases){
...
});})(map__60238,map__60238__$1,state,context,refers,aliases))
,mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (map__60238,map__60238__$1,state,context,refers,aliases){
return (function (p1__60235_SHARP_){
var and__4120__auto__ = (p1__60235_SHARP_ instanceof cljs.core.Symbol);
if(and__4120__auto__){
return cljs.core.namespace(p1__60235_SHARP_);
} else {
...
var G__60299 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__60300 = clojure.zip.next(loc);
loc = G__60300;
continue;
}
}
...
var len__4730__auto___60313 = arguments.length;
var i__4731__auto___60314 = (0);
while(true){
if((i__4731__auto___60314 < len__4730__auto___60313)){
args__4736__auto__.push((arguments[i__4731__auto___60314]));

var G__60315 = (i__4731__auto___60314 + (1));
i__4731__auto___60314 = G__60315;
continue;
} else {
}
break;
...
debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__60247){
var vec__60248 = p__60247;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60248,(0),null);
...
/** @this {Function} */
debux.common.util.form_header.cljs$lang$applyTo = (function (seq60244){
var G__60245 = cljs.core.first(seq60244);
var seq60244__$1 = cljs.core.next(seq60244);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__60245,seq60244__$1);
});

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__60251_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__60251_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__60265_60317 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__60266_60318 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__60267_60319 = true;
var _STAR_print_fn_STAR__temp_val__60268_60320 = ((function (_STAR_print_newline_STAR__orig_val__60265_60317,_STAR_print_fn_STAR__orig_val__60266_60318,_STAR_print_newline_STAR__temp_val__60267_60319,sb__4661__auto__,res){
return (function (x__4662__auto__){
return sb__4661__auto__.append(x__4662__auto__);
});})(_STAR_print_newline_STAR__orig_val__60265_60317,_STAR_print_fn_STAR__orig_val__60266_60318,_STAR_print_newline_STAR__temp_val__60267_60319,sb__4661__auto__,res))
;
cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__60267_60319;

cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__60268_60320;

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__60266_60318;

cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__60265_60317;
}
...
return (function (p1__60264_SHARP_){
return debux.common.util.prepend_bars(p1__60264_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__60321 = cljs.core.next(opts__$1);
var G__60322 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__60321;
acc = G__60322;
continue;
} else {
if(typeof f === 'string'){
var G__60323 = cljs.core.next(opts__$1);
var G__60324 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__60323;
acc = G__60324;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__60325 = cljs.core.nnext(opts__$1);
var G__60326 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__60325;
acc = G__60326;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__60327 = cljs.core.next(opts__$1);
var G__60328 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__60327;
acc = G__60328;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__60273 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__60273.cljs$core$IFn$_invoke$arity$1 ? fexpr__60273.cljs$core$IFn$_invoke$arity$1(f) : fexpr__60273.call(null,f));
})())){
var G__60329 = cljs.core.next(opts__$1);
var G__60330 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__60329;
acc = G__60330;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__60274 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__60274.cljs$core$IFn$_invoke$arity$1 ? fexpr__60274.cljs$core$IFn$_invoke$arity$1(f) : fexpr__60274.call(null,f));
})())){
var G__60331 = cljs.core.nnext(opts__$1);
var G__60332 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__60331;
acc = G__60332;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__60333 = cljs.core.next(opts__$1);
var G__60334 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__60333;
acc = G__60334;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__60275){
var vec__60276 = p__60275;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60276,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60276,(1),null);
...
var G__60282 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__60281 = (function (){var fexpr__60283 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten);
return (fexpr__60283.cljs$core$IFn$_invoke$arity$1 ? fexpr__60283.cljs$core$IFn$_invoke$arity$1(form) : fexpr__60283.call(null,form));
})();
return (fexpr__60281.cljs$core$IFn$_invoke$arity$1 ? fexpr__60281.cljs$core$IFn$_invoke$arity$1(G__60282) : fexpr__60281.call(null,G__60282));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__60285 = quoted_form;
var G__60286 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__60285,G__60286) : debux.common.util.remove_d.call(null,G__60285,G__60286));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__60287 = quoted_form;
var G__60288 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__60287,G__60288) : debux.common.util.remove_d.call(null,G__60287,G__60288));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__60335__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__60291 = quoted_form;
var G__60292 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__60291,G__60292) : debux.common.util.remove_d.call(null,G__60291,G__60292));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));

return result;
};
var G__60335 = function (var_args){
var arg = null;
if (arguments.length > 0) {
var G__60338__i = 0, G__60338__a = new Array(arguments.length -  0);
while (G__60338__i < G__60338__a.length) {G__60338__a[G__60338__i] = arguments[G__60338__i + 0]; ++G__60338__i;}
  arg = new cljs.core.IndexedSeq(G__60338__a,0,null);
} 
return G__60335__delegate.call(this,arg);};
G__60335.cljs$lang$maxFixedArity = 0;
G__60335.cljs$lang$applyTo = (function (arglist__60339){
var arg = cljs.core.seq(arglist__60339);
return G__60335__delegate(arg);
});
G__60335.cljs$core$IFn$_invoke$arity$variadic = G__60335__delegate;
return G__60335;
})()
;
});
...
var G__60346 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__60346;
continue;
} else {
...
var G__60347 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__60347;
continue;
} else {
var G__60348 = clojure.zip.next(loc);
loc = G__60348;
continue;
