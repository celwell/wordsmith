...
var G__48437_48461 = rewrite_clj.node.protocols.coerce;
var G__48438_48462 = "object";
var G__48439_48463 = ((function (G__48437_48461,G__48438_48462){
return (function (v){
return rewrite_clj.node.coercer.node_with_meta(rewrite_clj.node.token.token_node.cljs$core$IFn$_invoke$arity$1(v),v);
});})(G__48437_48461,G__48438_48462))
;
goog.object.set(G__48437_48461,G__48438_48462,G__48439_48463);
goog.object.set(rewrite_clj.node.protocols.NodeCoerceable,"number",true);

var G__48440_48464 = rewrite_clj.node.protocols.coerce;
var G__48441_48465 = "number";
var G__48442_48466 = ((function (G__48440_48464,G__48441_48465){
return (function (n){
return rewrite_clj.node.coercer.node_with_meta(rewrite_clj.node.token.token_node.cljs$core$IFn$_invoke$arity$1(n),n);
});})(G__48440_48464,G__48441_48465))
;
goog.object.set(G__48440_48464,G__48441_48465,G__48442_48466);
goog.object.set(rewrite_clj.node.protocols.NodeCoerceable,"string",true);

var G__48443_48467 = rewrite_clj.node.protocols.coerce;
var G__48444_48468 = "string";
var G__48445_48469 = ((function (G__48443_48467,G__48444_48468){
return (function (n){
return rewrite_clj.node.coercer.node_with_meta(rewrite_clj.node.stringz.string_node(n),n);
});})(G__48443_48467,G__48444_48468))
;
goog.object.set(G__48443_48467,G__48444_48468,G__48445_48469);
rewrite_clj.node.coercer.seq_node = (function rewrite_clj$node$coercer$seq_node(f,sq){
return rewrite_clj.node.coercer.node_with_meta((function (){var G__48446 = cljs.core.vec(rewrite_clj.node.whitespace.space_separated(cljs.core.map.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.coerce,sq)));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__48446) : f.call(null,G__48446));
})(),sq);
});
...
var comma_48471 = rewrite_clj.node.whitespace.whitespace_node(", ");
var space_48472 = rewrite_clj.node.whitespace.whitespace_node(" ");
rewrite_clj.node.coercer.map__GT_children = ((function (comma_48471,space_48472){
return (function rewrite_clj$node$coercer$map__GT_children(m){
return cljs.core.vec(cljs.core.butlast(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(((function (comma_48471,space_48472){
return (function (p__48448){
var vec__48450 = p__48448;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48450,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48450,(1),null);
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [rewrite_clj.node.protocols.coerce(k),space_48472,rewrite_clj.node.protocols.coerce(v),comma_48471], null);
});})(comma_48471,space_48472))
